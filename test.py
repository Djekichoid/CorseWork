...
canvas_hand5 = Canvas(frame_dealer, relief="groove", width=450, height=96, bg="#00B343", borderwidth=0)
...
temp5 = PhotoImage(file="images\\card_back.png")
canvas_hand5.create_image(40 + 40 * 9, 50, image=temp5)
root.mainloop()
